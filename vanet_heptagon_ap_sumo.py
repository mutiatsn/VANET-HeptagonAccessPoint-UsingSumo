...
def topology():
    ...
    net.telemetry(nodes=nodes, data_type='position',
                  min_x=2000, min_y=2800,
                  max_x=4200, max_y=5000)
